#ifndef N_DFS_UTIL_PARAMETER_H_
#define N_DFS_UTIL_PARAMETER_H_
...
namespace dfs {
  ...
  struct MetaServerParameter
  {
    ...
    static MetaServerParameter ns_parameter_;
    static MetaServerParameter& instance()
    {
...
#define SYSPARAM_NAMESERVER MetaServerParameter::instance()
