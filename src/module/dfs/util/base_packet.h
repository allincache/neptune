#ifndef N_DFS_UTIL_BASE_PACKET_H_
#define N_DFS_UTIL_BASE_PACKET_H_
...
enum DfsPacketVersion
{
  DFS_PACKET_VERSION_V0 = 0,
  DFS_PACKET_VERSION_V1 = 1,
  DFS_PACKET_VERSION_V2 = 2
};
...
static const uint32_t DFS_PACKET_FLAG_V0 = 0x4d534654;//DFSM
static const uint32_t DFS_PACKET_FLAG_V1 = 0x4e534654;//DFSN(V1)
static const int32_t DFS_PACKET_HEADER_V0_SIZE = sizeof(DfsPacketNewHeaderV0);
static const int32_t DFS_PACKET_HEADER_V1_SIZE = sizeof(DfsPacketNewHeaderV1);
static const int32_t DFS_PACKET_HEADER_DIFF_SIZE = DFS_PACKET_HEADER_V1_SIZE - DFS_PACKET_HEADER_V0_SIZE;
...
public:
  ...
  inline void set_connection(Connection* connection) { connection_ = connection;}
  inline Connection* get_connection() const { return connection_;}
