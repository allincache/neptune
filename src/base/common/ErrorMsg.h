#ifndef NEP_BASE_COMMON_ERRORMSG_H
#define NEP_BASE_COMMON_ERRORMSG_H
...
const int32_t EXIT_NAMESERVER_ONLY_READ = -5014;//current metaserver only read
...
const int32_t EXIT_DISCARD_NEWBLK_ERROR  = -5019;//metaserver in safe_mode_time, discard newblk packet
...
#endif //NEP_BASE_COMMON_ERRORMSG_H
