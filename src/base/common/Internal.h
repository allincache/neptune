#ifndef NEP_BASE_COMMON_INTERNAL_H
#define NEP_BASE_COMMON_INTERNAL_H
...
static const int64_t DFS_MALLOC_MAX_SIZE = 0x00A00000;//10M
...
struct SuperBlock
{
  ...
  char mount_point_[MAX_DEV_NAME_LEN]; // name of mount point
...
#endif //NEP_BASE_COMMON_INTERNAL_H
