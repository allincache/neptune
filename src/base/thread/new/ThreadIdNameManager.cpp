...
void ThreadIdNameManager::RegisterThread(PosixThreadHandle::Handle handle,
                                         PosixThreadId id) {
//  AutoLock locked(lock_);
...
void ThreadIdNameManager::SetName(const std::string& name) {
  PosixThreadId id = PosixThread::CurrentId();
...
//    AutoLock locked(lock_);
  ...
  //  }
    ...
    // means there is no PosixThreadHandler registered.
...
const char* ThreadIdNameManager::GetName(PosixThreadId id) {
//  AutoLock locked(lock_);
...
void ThreadIdNameManager::RemoveName(PosixThreadHandle::Handle handle,
                                     PosixThreadId id) {
//  AutoLock locked(lock_);
